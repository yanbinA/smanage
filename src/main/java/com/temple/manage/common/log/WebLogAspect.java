...
import com.temple.manage.common.utils.IpUtil;
...
public class WebLogAspect {
    @Pointcut("execution(public * com.temple.manage.controller.*.*(..))||execution(public * com.temple.manage.controller.*.*(..))")
    public void webLog() {
    }
